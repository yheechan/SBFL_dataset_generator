...
if __name__ == "__main__":
    ...
    for file in mutations_dir.iterdir():
        ...
        for mutation in file.iterdir():
            ...
            res = sp.call(cmd, cwd=bin_dir)
            if res != 0:
                print('{} - 5. Failed measure spectrum failed: {}'.format(template_name, res))
                continue
            print('{} - 5. Success measure spectrum: {}'.format(template_name, res))
            ...
            res = sp.call(cmd, cwd=bin_dir)
            if res != 0:
                print('{} - Failed save data failed: {}'.format(template_name, res))
                continue
            print('{} - 6. Success save data: {}'.format(template_name, res))
